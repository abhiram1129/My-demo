...
def suryaNamaskaram():
  ...
  def accuracyMeter(finalVal):

          if(finalVal<=25):
            accuracy="poor"
            cv2.rectangle(frame, (10,90),(835,625),(0,0,255),20)
          elif(finalVal>25 and finalVal<=50):
            accuracy="decent"
            cv2.rectangle(frame, (10,90),(835,625),(0,128,255),20)          
          elif(finalVal>50 and finalVal<=75):
            accuracy="good" 
            cv2.rectangle(frame, (10,90),(835,625),(0,255,255),20)
          elif(finalVal>75 and finalVal<=90):
            accuracy="very good"
            cv2.rectangle(frame, (10,90),(835,625),(0,255,255),20)  
          elif(finalVal>90):
            accuracy="perfect"
            cv2.rectangle(frame, (10,90),(835,625),(0,255,0),20)
          
          return(accuracy)
    
          #cv2.imshow(frame,meter)  

  #print(right_elbow_angle,left_elbow_angle)
      #cv2.putText(output_image, "Acccuracy : {}".format(accuracy) , (10, 30),cv2.FONT_HERSHEY_PLAIN, 2, (0, 0, 255), 2)
  ...
  while camera_video.isOpened():
      ...
      if landmarks:
          ...
          accuracyScore = accuracyMeter(avg)
